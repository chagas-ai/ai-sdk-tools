...
1. In npm, open each package and configure **Trusted Publisher**:
   - Package: `@chagas-ai/ai-sdk-tools-agents`
   - Package: `@chagas-ai/ai-sdk-tools-artifacts`
   - Package: `@chagas-ai/ai-sdk-tools-devtools`
   - Package: `@chagas-ai/ai-sdk-tools-memory`
   - Package: `@chagas-ai/ai-sdk-tools-store`
